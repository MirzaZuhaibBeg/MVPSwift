...
public struct ServiceHelperConstant {
    ...
    /// Errors
    public static let KInternetError = "Please check your internet connection."
    public static let KError = "Error"

    /// APIs
    public static let KSearchAPI = "search?"

    /// API Type
    public static let KGET = "GET"
    
    /// Parameter Keys
    public static let Kterm = "term"
    public static let Kentity = "entity"
}
...
class ServiceHelper: NSObject {
    ...
    ///
    /// - Parameter data: data
    /// - Returns: SearchItem array
    fileprivate func getSearchItemList(_ data: Any?) -> [SearchItem] {
    ...
    /// - Returns: SearchItem object
    fileprivate func getSearchItem(_ result: Any?) -> SearchItem {
